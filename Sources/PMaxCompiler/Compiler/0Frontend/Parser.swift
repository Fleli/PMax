...
class SLRParser {
	...
	private func state_0() throws {
        ...
        if topOfStackIsAmong([nil, Optional("struct"), Optional("import"), Optional("identifier")]) {
	...
	private func state_1() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("TopLevelStatement", input[index].content, "Function")
        } else {
	...
	private func state_17() throws {
        ...
        if topOfStackIsAmong([Optional("return"), Optional("identifier"), Optional("while"), Optional("if"), Optional("call"), Optional("}"), Optional("assign")]) {
	...
	private func state_19() throws {
        ...
        if topOfStackIsAmong([Optional("call"), Optional("}"), Optional("assign"), Optional("while"), Optional("if"), Optional("return"), Optional("identifier")]) {
	...
	private func state_28() throws {
        ...
        if topOfStackIsAmong([Optional("while"), Optional("if"), Optional("return"), Optional("call"), Optional("assign"), Optional("identifier"), Optional("}")]) {
	...
	private func state_117() throws {
        ...
        if topOfStackIsAmong([Optional("}"), Optional("identifier"), Optional("assign"), Optional("if"), Optional("call"), Optional("while"), Optional("return")]) {
            reduce(5, to: "If")
            return
        }
	...
	private func state_122() throws {
        ...
        if topOfStackIsAmong([Optional("assign"), Optional("while"), Optional("return"), Optional("}"), Optional("call"), Optional("identifier"), Optional("if")]) {
            reduce(3, to: "Return")
            return
        }
	...
	private func state_129() throws {
        ...
        if topOfStackIsAmong([Optional("return"), Optional("if"), Optional("identifier"), Optional("}"), Optional("call"), Optional("while"), Optional("assign")]) {
            reduce(6, to: "Call")
            return
        }
	...
	private func state_136() throws {
        ...
        if topOfStackIsAmong([Optional("while"), Optional("if"), Optional("return"), Optional("}"), Optional("call"), Optional("identifier"), Optional("assign")]) {
	...
	private func state_152() throws {
        ...
        if topOfStackIsAmong([Optional("if"), Optional("}"), Optional("call"), Optional("assign"), Optional("identifier"), Optional("while"), Optional("return")]) {
            reduce(5, to: "While")
            return
        }
	...
	private func state_163() throws {
        ...
        if topOfStackIsAmong([Optional("struct"), Optional("import"), nil, Optional("identifier")]) {
            reduce(5, to: "Struct")
            return
        }
