...
class SLRParser {
	...
	private func state_12() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("if"), Optional("assign"), Optional("}"), Optional("call"), Optional("return"), Optional("while")]) {
	...
	private func state_13() throws {
        ...
        if topOfStackIsAmong([Optional("call"), Optional("return"), Optional("assign"), Optional("if"), Optional("while"), Optional("}"), Optional("identifier")]) {
	...
	private func state_22() throws {
        ...
        if topOfStackIsAmong([Optional("if"), Optional("identifier"), Optional("}"), Optional("assign"), Optional("return"), Optional("call"), Optional("while")]) {
	...
	private func state_111() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("While", input[index].content, "Expression")
        } else {
            throw ParseError.abruptEnd("While", "Expression")
        }
	...
	private func state_117() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("Assignment", input[index].content, "Expression")
        } else {
	...
	private func state_119() throws {
        ...
        if topOfStackIsAmong([Optional("}"), Optional("return"), Optional("call"), Optional("identifier"), Optional("while"), Optional("if"), Optional("assign")]) {
	...
	private func state_133() throws {
        ...
        if topOfStackIsAmong([Optional("call"), Optional("assign"), Optional("identifier"), Optional("while"), Optional("}"), Optional("if"), Optional("return")]) {
            reduce(5, to: "While")
            return
        }
	...
	private func state_139() throws {
        ...
        if topOfStackIsAmong([Optional("while"), Optional("return"), Optional("if"), Optional("identifier"), Optional("}"), Optional("call"), Optional("assign")]) {
            reduce(6, to: "Call")
            return
        }
	...
	private func state_142() throws {
        ...
        if topOfStackIsAmong([Optional("assign"), Optional("if"), Optional("return"), Optional("call"), Optional("identifier"), Optional("while"), Optional("}")]) {
            reduce(3, to: "Return")
            return
        }
	...
	private func state_145() throws {
        ...
        if topOfStackIsAmong([Optional("assign"), Optional("identifier"), Optional("if"), Optional("}"), Optional("return"), Optional("while"), Optional("call")]) {
            reduce(5, to: "If")
            return
        }
