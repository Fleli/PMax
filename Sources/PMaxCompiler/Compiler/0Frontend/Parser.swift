...
class SLRParser {
	...
	private func state_16() throws {
        ...
        if topOfStackIsAmong([Optional("assign"), Optional("call"), Optional("identifier"), Optional("while"), Optional("if"), Optional("}"), Optional("return")]) {
            reduce(0, to: "FunctionBodyStatements")
            return
        }
        
        if index < input.count {
            throw ParseError.unexpected("Function", input[index].content, "FunctionBodyStatements")
        } else {
	...
	private func state_17() throws {
        ...
        if topOfStackIsAmong([Optional("}"), Optional("call"), Optional("assign"), Optional("if"), Optional("identifier"), Optional("while"), Optional("return")]) {
	...
	private func state_23() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("}"), Optional("call"), Optional("if"), Optional("assign"), Optional("while"), Optional("return")]) {
	...
	private func state_122() throws {
        ...
        if topOfStackIsAmong([Optional("return"), Optional("while"), Optional("assign"), Optional("identifier"), Optional("call"), Optional("}"), Optional("if")]) {
            reduce(3, to: "Return")
            return
        }
	...
	private func state_132() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("if"), Optional("}"), Optional("assign"), Optional("return"), Optional("while"), Optional("call")]) {
	...
	private func state_146() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("call"), Optional("}"), Optional("assign"), Optional("return"), Optional("if"), Optional("while")]) {
            reduce(5, to: "If")
            return
        }
	...
	private func state_149() throws {
        ...
        if topOfStackIsAmong([Optional("if"), Optional("return"), Optional("assign"), Optional("while"), Optional("}"), Optional("call"), Optional("identifier")]) {
            reduce(5, to: "While")
            return
        }
