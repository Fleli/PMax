...
public extension SLRNode {
	...
	func convertToAssignment() -> Assignment {
		...
		if type == "Assignment" && children.count == 4 && children[0].type == "identifier" && children[1].type == "=" && children[2].type == "Expression" && children[3].type == ";" {
...
public extension SLRNode {
	...
	func convertToReference() -> Reference {
		...
		if type == "Reference" && children.count == 4 && children[0].type == "identifier" && children[1].type == "(" && children[2].type == "Arguments" && children[3].type == ")" {
			let arg0 = children[0].convertToTerminal()
			let arg1 = children[1].convertToTerminal()
			let arg2 = children[2].convertToArguments()
			let arg3 = children[3].convertToTerminal()
			return Reference.call(arg0, arg1, arg2, arg3)
		}
