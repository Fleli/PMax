...
class SLRParser {
	...
	private func state_10() throws {
        ...
        if topOfStackIsAmong([Optional("assign"), Optional("if"), Optional("return"), Optional("}"), Optional("identifier"), Optional("while")]) {
	...
	private func state_12() throws {
        ...
        if topOfStackIsAmong([Optional("return"), Optional("if"), Optional("}"), Optional("assign"), Optional("identifier"), Optional("while")]) {
	...
	private func state_48() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("CASEDExpression", input[index].content, "CASEEExpression")
        } else {
	...
	private func state_100() throws {
        ...
        if topOfStackIsAmong([Optional("if"), Optional("assign"), Optional("identifier"), Optional("while"), Optional("return"), Optional("}")]) {
	...
	private func state_112() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("if"), Optional("assign"), Optional("while"), Optional("}"), Optional("return")]) {
            reduce(5, to: "If")
            return
        }
	...
	private func state_119() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("if"), Optional("while"), Optional("return"), Optional("assign"), Optional("}")]) {
	...
	private func state_123() throws {
        ...
        if topOfStackIsAmong([Optional("}"), Optional("assign"), Optional("identifier"), Optional("while"), Optional("if"), Optional("return")]) {
            reduce(3, to: "Return")
            return
        }
	...
	private func state_129() throws {
        ...
        if topOfStackIsAmong([Optional("}"), Optional("return"), Optional("assign"), Optional("while"), Optional("identifier"), Optional("if")]) {
            reduce(5, to: "While")
            return
        }
	...
	private func state_130() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("struct"), nil]) {
