...
class SLRParser {
	...
	private func state_15() throws {
        ...
        if topOfStackIsAmong([Optional("}"), Optional("if"), Optional("assign"), Optional("return"), Optional("identifier"), Optional("while")]) {
	...
	private func state_16() throws {
        ...
        if topOfStackIsAmong([Optional("assign"), Optional("if"), Optional("}"), Optional("return"), Optional("identifier"), Optional("while")]) {
	...
	private func state_24() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("if"), Optional("}"), Optional("while"), Optional("assign"), Optional("return")]) {
	...
	private func state_124() throws {
        ...
        if topOfStackIsAmong([Optional("return"), Optional("identifier"), Optional("while"), Optional("if"), Optional("}"), Optional("assign")]) {
	...
	private func state_127() throws {
        ...
        if topOfStackIsAmong([Optional("if"), Optional("return"), Optional("while"), Optional("identifier"), Optional("}"), Optional("assign")]) {
            reduce(3, to: "Return")
            return
        }
	...
	private func state_133() throws {
        ...
        if topOfStackIsAmong([Optional("}"), Optional("assign"), Optional("while"), Optional("return"), Optional("if"), Optional("identifier")]) {
            reduce(5, to: "While")
            return
        }
	...
	private func state_134() throws {
        ...
        if topOfStackIsAmong([Optional("while"), Optional("if"), Optional("}"), Optional("identifier"), Optional("assign"), Optional("return")]) {
            reduce(5, to: "If")
            return
        }
