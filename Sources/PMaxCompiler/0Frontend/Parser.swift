...
class SLRParser {
	...
	private func state_16() throws {
        ...
        if topOfStackIsAmong([Optional("while"), Optional("return"), Optional("identifier"), Optional("if"), Optional("}"), Optional("assign")]) {
            reduce(0, to: "FunctionBodyStatements")
            return
        }
        
        if index < input.count {
            throw ParseError.unexpected("FunctionBodyStatement", input[index].content, "Declaration")
        } else {
	...
	private func state_17() throws {
        ...
        if topOfStackIsAmong([Optional("if"), Optional("identifier"), Optional("while"), Optional("return"), Optional("assign"), Optional("}")]) {
	...
	private func state_21() throws {
        ...
        if topOfStackIsAmong([Optional("if"), Optional("assign"), Optional("}"), Optional("return"), Optional("identifier"), Optional("while")]) {
	...
	private func state_22() throws {
        ...
        if topOfStackIsNonTerminal("CASEMExpression") {
            pushState(state_23)
            return
        }
	...
	private func state_26() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("CASEMExpression", input[index].content, "integer")
        } else {
            throw ParseError.abruptEnd("CASEMExpression", "integer")
        }
	...
	private func state_29() throws {
        ...
        if topOfStackIsAmong([Optional("!="), Optional("&&"), Optional("&"), Optional(">"), Optional("{"), Optional("+"), Optional("=="), Optional("%"), Optional(";"), Optional(","), Optional("*"), Optional("/"), Optional("-"), Optional("<"), Optional("<<"), Optional(">="), Optional(">>"), Optional("^"), Optional("|"), Optional("<="), Optional("||"), Optional(")")]) {
            reduce(1, to: "CASEMExpression")
            return
        }
        
        if index < input.count {
            throw ParseError.unexpected("CASEMExpression", input[index].content, "reduction")
        } else {
            throw ParseError.abruptEnd("CASEMExpression", "reduction")
        }
	...
	private func state_33() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("CASEMExpression", input[index].content, "(")
        } else {
            throw ParseError.abruptEnd("CASEMExpression", "(")
        }
	...
	private func state_44() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("CASEMExpression", input[index].content, "identifier")
        } else {
            throw ParseError.abruptEnd("CASEMExpression", "identifier")
        }
	...
	private func state_69() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("CASEMExpression", input[index].content, "Reference")
        } else {
            throw ParseError.abruptEnd("CASEMExpression", "Reference")
        }
	...
	private func state_73() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("CASELExpression", input[index].content, "CASEMExpression")
        } else {
            throw ParseError.abruptEnd("CASELExpression", "CASEMExpression")
        }
	...
	private func state_100() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("Arguments", input[index].content, "Argument")
        } else {
            throw ParseError.abruptEnd("Arguments", "Argument")
        }
	...
	private func state_120() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("while"), Optional("return"), Optional("assign"), Optional("if"), Optional("}")]) {
            reduce(5, to: "If")
            return
        }
	...
	private func state_127() throws {
        ...
        if topOfStackIsAmong([Optional("while"), Optional("if"), Optional("assign"), Optional("return"), Optional("identifier"), Optional("}")]) {
	...
	private func state_133() throws {
        ...
        if topOfStackIsAmong([Optional("if"), Optional("return"), Optional("assign"), Optional("}"), Optional("while"), Optional("identifier")]) {
            reduce(5, to: "While")
            return
        }
