class LiteralPool {
    ...
    /// Notify the literal pool that an integer literal was encountered. If the literal hasn't been seen yet, a new instance is created. Otherwise, the existing literal is simply reused.
