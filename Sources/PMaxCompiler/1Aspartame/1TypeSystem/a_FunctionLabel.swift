class FunctionLabel {
    ...
    /// When the grammatical statements from the syntactic front end gets lowered, the resulting `AspartameStatement` objects get stored here.
    let body: [Label] = []
    ...
    init?(_ function: Function, _ aspartame: Aspartame) {
        ...
        self.environment = Environment(aspartame)
