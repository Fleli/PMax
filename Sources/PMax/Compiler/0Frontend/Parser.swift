...
class SLRParser {
	...
	private func state_1() throws {
        ...
        if topOfStackIsAmong([Optional("import"), nil, Optional("identifier"), Optional("struct"), Optional("macro")]) {
	...
	private func state_2() throws {
        ...
        if index < input.count {
            throw ParseError.unexpected("Import", input[index].content, "import")
        } else {
	...
	private func state_14() throws {
        ...
        if topOfStackIsAmong([Optional("}"), Optional("return"), Optional("identifier"), Optional("assign"), Optional("if"), Optional("while"), Optional("call")]) {
	...
	private func state_15() throws {
        ...
        if topOfStackIsAmong([Optional("if"), Optional("identifier"), Optional("return"), Optional("assign"), Optional("while"), Optional("call"), Optional("}")]) {
	...
	private func state_108() throws {
        ...
        if topOfStackIsAmong([Optional("while"), Optional("}"), Optional("assign"), Optional("if"), Optional("call"), Optional("identifier"), Optional("return")]) {
	...
	private func state_119() throws {
        ...
        if topOfStackIsAmong([Optional("while"), Optional("}"), Optional("return"), Optional("identifier"), Optional("assign"), Optional("call"), Optional("if")]) {
            reduce(6, to: "Call")
            return
        }
	...
	private func state_134() throws {
        ...
        if topOfStackIsAmong([Optional("call"), Optional("assign"), Optional("identifier"), Optional("}"), Optional("return"), Optional("while"), Optional("if")]) {
	...
	private func state_148() throws {
        ...
        if topOfStackIsAmong([Optional("while"), Optional("call"), Optional("assign"), Optional("return"), Optional("if"), Optional("identifier"), Optional("}")]) {
            reduce(3, to: "Return")
            return
        }
	...
	private func state_150() throws {
        ...
        if topOfStackIsAmong([Optional("}"), Optional("call"), Optional("return"), Optional("if"), Optional("while"), Optional("assign"), Optional("identifier")]) {
            reduce(5, to: "If")
            return
        }
	...
	private func state_153() throws {
        ...
        if topOfStackIsAmong([Optional("assign"), Optional("return"), Optional("}"), Optional("call"), Optional("if"), Optional("while"), Optional("identifier")]) {
            reduce(1, to: "Else")
            return
        }
	...
	private func state_158() throws {
        ...
        if topOfStackIsAmong([Optional("return"), Optional("assign"), Optional("}"), Optional("identifier"), Optional("while"), Optional("if"), Optional("call")]) {
	...
	private func state_159() throws {
        ...
        if topOfStackIsAmong([Optional("return"), Optional("}"), Optional("call"), Optional("identifier"), Optional("if"), Optional("while"), Optional("assign")]) {
            reduce(5, to: "While")
            return
        }
	...
	private func state_160() throws {
        ...
        if topOfStackIsAmong([nil, Optional("macro"), Optional("struct"), Optional("identifier"), Optional("import")]) {
	...
	private func state_176() throws {
        ...
        if topOfStackIsAmong([Optional("macro"), Optional("identifier"), Optional("import"), nil, Optional("struct")]) {
            reduce(5, to: "Macro")
            return
        }
	...
	private func state_179() throws {
        ...
        if topOfStackIsAmong([Optional("identifier"), Optional("struct"), nil, Optional("import"), Optional("macro")]) {
            reduce(3, to: "Import")
            return
        }
